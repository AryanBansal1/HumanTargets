    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity security,CustomSuccessHandler customSuccessHandler)throws Exception{
        return security
                ...
                .authorizeHttpRequests(request -> request
                                                       .requestMatchers("/","/index.html","/css/**","/img/**","/js/**","/lib/**","/scss/**","/login.html","/register.html","/register_process","/404.html","/about.html","/causes.html","/team.html","/contact.html","/contactus","/api/payment/**","/success.html","/cancel.html").permitAll()
